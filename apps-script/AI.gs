...
var KATEGORI_KEYWORDS = {
  makan: ['makan', 'makanan', 'minuman', 'jajan', 'jajanan', 'ngemil', 'cemilan', 'nongki', 'kopi', 'ngopi', 'cafe', 'kafe', 'resto', 'restoran', 'warung', 'warteg', 'gofood', 'grabfood', 'shopeefood', 'snack', 'kue', 'roti', 'catering', 'nasi goreng', 'nasi padang', 'ayam geprek', 'bakso', 'mie ayam', 'bakmi', 'sate', 'martabak', 'gorengan', 'jus', 'boba', 'seblak', 'air mineral', 'pizza', 'burger', 'kfc', 'mcd', 'mcdonald', 'starbucks', 'es teh', 'es krim', 'dimsum', 'kebab', 'donat', 'soto', 'pecel', 'gado-gado', 'kantin', 'angkringan', 'lalapan', 'frozen food'],
  transport: ['bensin', 'bbm', 'pertalite', 'pertamax', 'solar', 'dexlite', 'spbu', 'shell', 'ojek', 'ojol', 'grab', 'gojek', 'gocar', 'grabbike', 'grabcar', 'maxim', 'indriver', 'taksi', 'taxi', 'angkot', 'busway', 'transjakarta', 'damri', 'mikrolet', 'kereta', 'krl', 'mrt', 'lrt', 'commuter', 'tol', 'e-toll', 'etoll', 'parkir', 'ongkos', 'tiket pesawat', 'tiket kereta', 'tiket bus', 'tiket kapal', 'pesawat', 'ferry', 'servis motor', 'servis mobil', 'ganti oli', 'oli', 'tambal ban', 'ban motor', 'bengkel', 'cuci motor', 'cuci mobil', 'derek', 'pajak kendaraan', 'stnk', 'rental mobil', 'travel', 'isi bensin'],
  belanja: ['sampo', 'shampoo', 'sabun', 'sabun mandi', 'sabun cuci', 'odol', 'pasta gigi', 'sikat gigi', 'deterjen', 'pewangi', 'pelembut', 'tisu', 'tissue', 'skincare', 'kosmetik', 'bedak', 'lipstik', 'parfum', 'sunscreen', 'handbody', 'lotion', 'deodorant', 'pembalut', 'baju', 'pakaian', 'celana', 'kaos', 'kemeja', 'jaket', 'jilbab', 'hijab', 'gamis', 'sepatu', 'sandal', 'kaos kaki', 'tas', 'dompet', 'jam tangan', 'kacamata', 'aksesoris', 'alat tulis', 'pulpen', 'pensil', 'buku tulis', 'kertas', 'elektronik', 'gadget', 'charger', 'kabel', 'powerbank', 'mouse', 'keyboard', 'flashdisk', 'casing', 'earphone', 'headset', 'shopee', 'tokopedia', 'lazada', 'blibli', 'bukalapak', 'tiktok shop', 'olshop', 'belanja', 'minimarket', 'indomaret', 'alfamart', 'transmart', 'hypermart', 'superindo', 'uniqlo', 'erafone', 'ibox', 'hp', 'laptop', 'komputer', 'printer', 'servis hp', 'service hp', 'perbaikan hp', 'ganti baterai', 'ganti lcd', 'servis laptop', 'rokok', 'vape', 'kado', 'salon', 'potong rambut', 'barbershop', 'cukur', 'pangkas rambut', 'creambath', 'facial', 'fotokopi', 'print'],
  tagihan: ['bpjs', 'asuransi', 'premi', 'listrik', 'pln', 'token listrik', 'token pln', 'pdam', 'tagihan air', 'telepon', 'telkom', 'indihome', 'first media', 'biznet', 'myrepublic', 'iconnet', 'wifi', 'internet rumah', 'tv kabel', 'iuran', 'iuran rt', 'iuran sampah', 'sampah', 'keamanan', 'cicilan', 'angsuran', 'kartu kredit', 'kredit', 'kpr', 'paylater', 'kredivo', 'akulaku', 'spaylater', 'home credit', 'leasing', 'pbb', 'pajak bumi', 'biaya admin', 'admin bank', 'pajak penghasilan', 'pph'],
  pulsa: ['pulsa', 'isi pulsa', 'beli pulsa', 'kuota', 'kuota internet', 'paket data', 'paket internet', 'paketan', 'telkomsel', 'indosat', 'im3', 'smartfren', 'by.u'],
  hiburan: ['netflix', 'spotify', 'disney', 'youtube premium', 'amazon prime', 'prime video', 'apple music', 'joox', 'vidio', 'wetv', 'viu', 'iqiyi', 'hbo', 'bioskop', 'xxi', 'cgv', 'nonton', 'tiket bioskop', 'tiket konser', 'konser', 'game', 'top up game', 'voucher game', 'mobile legend', 'free fire', 'pubg', 'genshin', 'valorant', 'roblox', 'steam', 'playstation', 'nintendo', 'karaoke', 'wisata', 'liburan', 'rekreasi', 'tiket masuk', 'dufan', 'waterboom', 'kebun binatang', 'wahana'],
  kesehatan: ['obat', 'apotek', 'apotik', 'dokter', 'dokter gigi', 'rumah sakit', 'klinik', 'puskesmas', 'igd', 'rawat inap', 'rawat jalan', 'kontrol', 'periksa', 'cek darah', 'cek kesehatan', 'medical checkup', 'lab', 'laboratorium', 'rontgen', 'usg', 'operasi', 'fisioterapi', 'terapi', 'vitamin', 'suplemen', 'vaksin', 'imunisasi', 'paracetamol', 'antibiotik', 'salep', 'betadine', 'plester', 'koyo', 'balsem', 'minyak kayu putih', 'tolak angin', 'promag', 'bodrex', 'panadol', 'obat batuk', 'obat demam', 'tetes mata', 'behel', 'scaling', 'tambal gigi', 'cabut gigi', 'bidan', 'persalinan', 'melahirkan', 'masker medis', 'pijat', 'spa', 'massage', 'refleksi', 'luluran'],
  pendidikan: ['sekolah', 'kuliah', 'kursus', 'les', 'les privat', 'bimbel', 'spp', 'uang sekolah', 'uang gedung', 'uang pangkal', 'daftar ulang', 'buku', 'modul', 'seminar', 'pelatihan', 'training', 'webinar', 'wisuda', 'skripsi', 'praktikum', 'toefl', 'ielts', 'sertifikasi', 'ruangguru', 'zenius', 'quipper', 'udemy', 'coursera', 'skill academy'],
  rumah: ['perabot', 'perabotan', 'furniture', 'mebel', 'perlengkapan rumah', 'perbaikan rumah', 'renovasi', 'galon', 'galon air', 'elpiji', 'lpg', 'gas elpiji', 'gas 3kg', 'tabung gas', 'gas', 'sapu', 'pel', 'ember', 'panci', 'wajan', 'piring', 'gelas', 'kompor', 'rice cooker', 'kulkas', 'mesin cuci', 'kipas angin', 'kasur', 'bantal', 'sprei', 'gorden', 'lemari', 'lampu', 'cat tembok', 'semen', 'keramik', 'paku', 'tukang', 'service ac', 'servis ac', 'asisten rumah tangga', 'pembantu', 'sewa rumah', 'kontrakan', 'bayar kos', 'kos', 'kost', 'laundry', 'cuci baju', 'setrika'],
  anak: ['popok', 'pampers', 'diapers', 'susu anak', 'susu formula', 'sufor', 'bubur bayi', 'biskuit bayi', 'mainan', 'mainan anak', 'baju anak', 'sepatu anak', 'stroller', 'gendongan', 'box bayi', 'minyak telon', 'bedak bayi', 'sabun bayi', 'daycare', 'perlengkapan bayi'],
  sedekah: ['sedekah', 'sodaqoh', 'zakat', 'infaq', 'infak', 'donasi', 'sumbangan', 'amal', 'wakaf', 'qurban', 'kurban', 'fidyah', 'santunan', 'kotak amal'],
  olahraga: ['gym', 'fitness', 'fitnes', 'membership gym', 'jogging', 'lari', 'sepeda', 'gowes', 'futsal', 'badminton', 'renang', 'kolam renang', 'sewa lapangan', 'yoga', 'zumba', 'raket', 'shuttlecock', 'whey protein', 'matras yoga']
};
